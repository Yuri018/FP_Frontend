...
const RegisterPage: React.FC<IPropsRegistr> = (props: IPropsRegistr): JSX.Element => {
    ...
    return (
        <>
            ...
            <TextField fullWidth={true}  margin="dense" label="Email" variant="outlined" placeholder="Введите ваш Email"  size="small" onChange={e => setUsername(e.target.value)} />
            <TextField type="password" fullWidth={true} margin="dense" label="Password" variant="outlined" placeholder="Введите ваш password"  size="small" onChange={e => setPassword(e.target.value)}/>
            <Button 
                type="submit"
                size="small" 
                variant="contained"
